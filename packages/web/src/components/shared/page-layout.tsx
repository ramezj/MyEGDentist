...
const pageTitleClass =
  "text-xl font-semibold tracking-tighter truncate min-w-0";
  ...
  if (variant === "header") {
    return (
      <div className={cn("flex flex-1 flex-col", className)}>
        {/* Sticky Page Header */}
        <div className="sticky h-16 top-0 z-20 border-b bg-background/95 items-center content-center px-4 backdrop-blur supports-backdrop-filter:bg-background/60">
...
export function LoadingLayout({
  ...
  return (
    <PageLayout variant="header" title={title} primaryButton={primaryButton}>
